...
public class GetCoordThread extends Thread {
    ...
    public GetCoordThread(boolean receiver, String x, String y, String from, String to)
    {
    ...
    private void showtext() {
        handler.post((new Runnable() {
            ...
            public void run() {
                active=false;
                MainActivity3.TransCoordThreadResponse(x, y);
            }
        }));
    }
}
