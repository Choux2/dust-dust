...
public class GetDustThread3 extends Thread {
    ...
    public GetDustThread3(boolean receiver, String dong){
    ...
    public void run(){
        ...
        if(active){
            try{
                ...
                String dustUrl = "http://apis.data.go.kr/B552584/ArpltnInforInqireSvc/getMsrstnAcctoRltmMesureDnsty?"
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                if(tResponse){
                    tResponse=false;
                    data=0;
                    MainActivity3.DustThreadResponse(stotalCount, stvDate, stvpm10, stvpm10grade, stvpm25, stvpm25grade,
                            stvo3, stvo3grade, stvno2, stvno2grade, stvco, stvcograde, stvso2, stvso2grade);
                }
            }
        });
