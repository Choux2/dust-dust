...
public class MainActivity3 extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    void getStation(String yGrid, String xGrid) {
        ...
        if (xGrid != null && yGrid != null) {
            GetCoordThread.active = true;
            GetCoordThread getCoordthread = new GetCoordThread(false, xGrid, yGrid, from, to);        //스레드생성(UI 스레드사용시 system 뻗는다)
